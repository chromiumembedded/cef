...
"""
        ...
        self.assertEqual(file_errors.errors[0].error_line, 3)  # Error is on line 3
...
"""
        ...
        self.assertEqual(error['build_output_line'], 3)
...
"""
        ...
        self.assertIn('build.txt:3', summary)  # Line reference (error is on line 3)
...
"""
        ...
        self.assertEqual(file_errors.errors[0].error_line, 3)  # Error is on line 3 of the output
