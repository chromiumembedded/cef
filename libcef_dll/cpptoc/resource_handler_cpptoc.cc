...
int CEF_CALLBACK resource_handler_open(struct _cef_resource_handler_t* self, struct _cef_request_t* request, int* handle_request, struct _cef_callback_t* callback) {
...
int CEF_CALLBACK resource_handler_process_request(struct _cef_resource_handler_t* self, struct _cef_request_t* request, struct _cef_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK resource_handler_get_response_headers(struct _cef_resource_handler_t* self, struct _cef_response_t* response, int64_t* response_length, cef_string_t* redirectUrl) {
  shutdown_checker::AssertNotShutdown();
...
int CEF_CALLBACK resource_handler_skip(struct _cef_resource_handler_t* self, int64_t bytes_to_skip, int64_t* bytes_skipped, struct _cef_resource_skip_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
...
int CEF_CALLBACK resource_handler_read(struct _cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read, struct _cef_resource_read_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
...
int CEF_CALLBACK resource_handler_read_response(struct _cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read, struct _cef_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
...
template<> CefRefPtr<CefResourceHandler> CefCppToCRefCounted<CefResourceHandlerCppToC, CefResourceHandler, cef_resource_handler_t>::UnwrapDerived(CefWrapperType type, cef_resource_handler_t* s) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCppToCRefCounted<CefResourceHandlerCppToC, CefResourceHandler, cef_resource_handler_t>::kWrapperType = WT_RESOURCE_HANDLER;
