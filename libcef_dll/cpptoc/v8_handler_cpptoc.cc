...
int CEF_CALLBACK v8_handler_execute(struct _cef_v8_handler_t* self, const cef_string_t* name, struct _cef_v8_value_t* object, size_t argumentsCount, struct _cef_v8_value_t* const* arguments, struct _cef_v8_value_t** retval, cef_string_t* exception) {
...
template<> CefRefPtr<CefV8Handler> CefCppToCRefCounted<CefV8HandlerCppToC, CefV8Handler, cef_v8_handler_t>::UnwrapDerived(CefWrapperType type, cef_v8_handler_t* s) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCppToCRefCounted<CefV8HandlerCppToC, CefV8Handler, cef_v8_handler_t>::kWrapperType = WT_V8_HANDLER;
