...
int CEF_CALLBACK request_handler_on_before_browse(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, struct _cef_frame_t* frame, struct _cef_request_t* request, int user_gesture, int is_redirect) {
...
int CEF_CALLBACK request_handler_on_open_urlfrom_tab(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, struct _cef_frame_t* frame, const cef_string_t* target_url, cef_window_open_disposition_t target_disposition, int user_gesture) {
  shutdown_checker::AssertNotShutdown();
...
struct _cef_resource_request_handler_t* CEF_CALLBACK request_handler_get_resource_request_handler(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, struct _cef_frame_t* frame, struct _cef_request_t* request, int is_navigation, int is_download, const cef_string_t* request_initiator, int* disable_default_handling) {
  ...
  // Execute
  CefRefPtr<CefResourceRequestHandler> _retval = CefRequestHandlerCppToC::Get(self)->GetResourceRequestHandler(
      CefBrowserCToCpp_Wrap(browser),
      CefFrameCToCpp_Wrap(frame),
      CefRequestCToCpp_Wrap(request),
...
int CEF_CALLBACK request_handler_get_auth_credentials(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, const cef_string_t* origin_url, int isProxy, const cef_string_t* host, int port, const cef_string_t* realm, const cef_string_t* scheme, struct _cef_auth_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
  ...
  bool _retval = CefRequestHandlerCppToC::Get(self)->GetAuthCredentials(
      ...
      CefString(realm),
      CefString(scheme),
      CefAuthCallbackCToCpp_Wrap(callback));

  // Return type: bool
  return _retval;
}

int CEF_CALLBACK request_handler_on_certificate_error(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, cef_errorcode_t cert_error, const cef_string_t* request_url, struct _cef_sslinfo_t* ssl_info, struct _cef_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
  ...
  bool _retval = CefRequestHandlerCppToC::Get(self)->OnCertificateError(
      ...
      CefSSLInfoCToCpp_Wrap(ssl_info),
...
int CEF_CALLBACK request_handler_on_select_client_certificate(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, int isProxy, const cef_string_t* host, int port, size_t certificatesCount, struct _cef_x509_certificate_t* const* certificates, struct _cef_select_client_certificate_callback_t* callback) {
  ...
  if (certificatesCount > 0) {
    for (size_t i = 0; i < certificatesCount; ++i) {
      CefRefPtr<CefX509Certificate> certificatesVal = CefX509CertificateCToCpp_Wrap(certificates[i]);
...
void CEF_CALLBACK request_handler_on_render_view_ready(struct _cef_request_handler_t* self, struct _cef_browser_t* browser) {
  shutdown_checker::AssertNotShutdown();
...
int CEF_CALLBACK request_handler_on_render_process_unresponsive(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, struct _cef_unresponsive_process_callback_t* callback) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval = CefRequestHandlerCppToC::Get(self)->OnRenderProcessUnresponsive(
      CefBrowserCToCpp_Wrap(browser),
...
void CEF_CALLBACK request_handler_on_render_process_responsive(struct _cef_request_handler_t* self, struct _cef_browser_t* browser) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK request_handler_on_render_process_terminated(struct _cef_request_handler_t* self, struct _cef_browser_t* browser, cef_termination_status_t status, int error_code, const cef_string_t* error_string) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK request_handler_on_document_available_in_main_frame(struct _cef_request_handler_t* self, struct _cef_browser_t* browser) {
  shutdown_checker::AssertNotShutdown();
...
CefRequestHandlerCppToC::CefRequestHandlerCppToC() {
  ...
  GetStruct()->get_resource_request_handler = request_handler_get_resource_request_handler;
  ...
  GetStruct()->on_render_process_unresponsive = request_handler_on_render_process_unresponsive;
  GetStruct()->on_render_process_responsive = request_handler_on_render_process_responsive;
  GetStruct()->on_render_process_terminated = request_handler_on_render_process_terminated;
  GetStruct()->on_document_available_in_main_frame = request_handler_on_document_available_in_main_frame;
}
...
template<> CefRefPtr<CefRequestHandler> CefCppToCRefCounted<CefRequestHandlerCppToC, CefRequestHandler, cef_request_handler_t>::UnwrapDerived(CefWrapperType type, cef_request_handler_t* s) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCppToCRefCounted<CefRequestHandlerCppToC, CefRequestHandler, cef_request_handler_t>::kWrapperType = WT_REQUEST_HANDLER;
