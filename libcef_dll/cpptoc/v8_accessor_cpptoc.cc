...
int CEF_CALLBACK v8_accessor_get(struct _cef_v8_accessor_t* self, const cef_string_t* name, struct _cef_v8_value_t* object, struct _cef_v8_value_t** retval, cef_string_t* exception) {
...
int CEF_CALLBACK v8_accessor_set(struct _cef_v8_accessor_t* self, const cef_string_t* name, struct _cef_v8_value_t* object, struct _cef_v8_value_t* value, cef_string_t* exception) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
template<> CefRefPtr<CefV8Accessor> CefCppToCRefCounted<CefV8AccessorCppToC, CefV8Accessor, cef_v8_accessor_t>::UnwrapDerived(CefWrapperType type, cef_v8_accessor_t* s) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCppToCRefCounted<CefV8AccessorCppToC, CefV8Accessor, cef_v8_accessor_t>::kWrapperType = WT_V8_ACCESSOR;
