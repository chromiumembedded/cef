...
NO_SANITIZE("cfi-icall") bool CefValueCToCpp::IsSame(CefRefPtr<CefValue> that) {
  ...
  int _retval = _struct->is_same(_struct,
      CefValueCToCpp_Unwrap(that));

  // Return type: bool
  return _retval?true:false;
}

NO_SANITIZE("cfi-icall") bool CefValueCToCpp::IsEqual(CefRefPtr<CefValue> that) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefDictionaryValue> CefValueCToCpp::GetDictionary() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefValueCToCpp::SetString(const CefString& value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefValueCToCpp::SetBinary(CefRefPtr<CefBinaryValue> value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefValueCToCpp::SetDictionary(CefRefPtr<CefDictionaryValue> value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefValueCToCpp::SetList(CefRefPtr<CefListValue> value) {
  shutdown_checker::AssertNotShutdown();
...
template<> cef_value_t* CefCToCppRefCounted<CefValueCToCpp, CefValue, cef_value_t>::UnwrapDerived(CefWrapperType type, CefValue* c) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCToCppRefCounted<CefValueCToCpp, CefValue, cef_value_t>::kWrapperType = WT_VALUE;
