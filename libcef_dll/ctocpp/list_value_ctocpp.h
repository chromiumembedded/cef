...
class CefListValueCToCpp
    : public CefCToCppRefCounted<CefListValueCToCpp, CefListValue, cef_list_value_t> {
 public:
  CefListValueCToCpp();
  ...
  bool SetDictionary(size_t index, CefRefPtr<CefDictionaryValue> value) override;
