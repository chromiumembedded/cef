...
class CefMediaSinkCToCpp
    : public CefCToCppRefCounted<CefMediaSinkCToCpp, CefMediaSink, cef_media_sink_t> {
 public:
  CefMediaSinkCToCpp();
  ...
  void GetDeviceInfo(CefRefPtr<CefMediaSinkDeviceInfoCallback> callback) override;
