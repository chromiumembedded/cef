...
//
// $hash=c44c43d19616a44935cac2ae8c9333d36f3b678c$
//
...
class CefWindowDelegate_0_CToCpp
    : public CefCToCppRefCounted<CefWindowDelegate_0_CToCpp, CefWindowDelegate, cef_window_delegate_0_t> {
 public:
  CefWindowDelegate_0_CToCpp();
  virtual ~CefWindowDelegate_0_CToCpp();
...
constexpr auto CefWindowDelegateCToCpp_Wrap = CefWindowDelegate_0_CToCpp::Wrap;
constexpr auto CefWindowDelegateCToCpp_Unwrap = CefWindowDelegate_0_CToCpp::Unwrap;
