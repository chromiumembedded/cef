...
NO_SANITIZE("cfi-icall") CefRefPtr<CefBrowserView> CefViewCToCpp::AsBrowserView() {
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefScrollView> CefViewCToCpp::AsScrollView() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefString CefViewCToCpp::ToString(bool include_children) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefViewDelegate> CefViewCToCpp::GetDelegate() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefView> CefViewCToCpp::GetViewForID(int id) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") void CefViewCToCpp::SetPosition(const CefPoint& position) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") void CefViewCToCpp::SetInsets(const CefInsets& insets) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") cef_color_t CefViewCToCpp::GetThemeColor(int color_id) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointToScreen(CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointFromScreen(CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointToWindow(CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointFromWindow(CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointToView(CefRefPtr<CefView> view, CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") bool CefViewCToCpp::ConvertPointFromView(CefRefPtr<CefView> view, CefPoint& point) {
  shutdown_checker::AssertNotShutdown();
...
template<> cef_view_t* CefCToCppRefCounted<CefViewCToCpp, CefView, cef_view_t>::UnwrapDerived(CefWrapperType type, CefView* c) {
  if (type == WT_BROWSER_VIEW) {
    return reinterpret_cast<cef_view_t*>(CefBrowserViewCToCpp_Unwrap(reinterpret_cast<CefBrowserView*>(c)));
  }
  if (type == WT_BUTTON) {
    return reinterpret_cast<cef_view_t*>(CefButtonCToCpp_Unwrap(reinterpret_cast<CefButton*>(c)));
  }
  if (type == WT_LABEL_BUTTON) {
    return reinterpret_cast<cef_view_t*>(CefLabelButtonCToCpp_Unwrap(reinterpret_cast<CefLabelButton*>(c)));
  }
  if (type == WT_MENU_BUTTON) {
    return reinterpret_cast<cef_view_t*>(CefMenuButtonCToCpp_Unwrap(reinterpret_cast<CefMenuButton*>(c)));
  }
  if (type == WT_PANEL) {
    return reinterpret_cast<cef_view_t*>(CefPanelCToCpp_Unwrap(reinterpret_cast<CefPanel*>(c)));
  }
  if (type == WT_SCROLL_VIEW) {
    return reinterpret_cast<cef_view_t*>(CefScrollViewCToCpp_Unwrap(reinterpret_cast<CefScrollView*>(c)));
  }
  if (type == WT_TEXTFIELD) {
    return reinterpret_cast<cef_view_t*>(CefTextfieldCToCpp_Unwrap(reinterpret_cast<CefTextfield*>(c)));
  }
  if (type == WT_WINDOW) {
    return reinterpret_cast<cef_view_t*>(CefWindowCToCpp_Unwrap(reinterpret_cast<CefWindow*>(c)));
  }
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCToCppRefCounted<CefViewCToCpp, CefView, cef_view_t>::kWrapperType = WT_VIEW;
