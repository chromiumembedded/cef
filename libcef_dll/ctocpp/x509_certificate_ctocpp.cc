...
NO_SANITIZE("cfi-icall") CefRefPtr<CefX509CertPrincipal> CefX509CertificateCToCpp::GetSubject() {
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefX509CertPrincipal> CefX509CertificateCToCpp::GetIssuer() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefBinaryValue> CefX509CertificateCToCpp::GetSerialNumber() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefBaseTime CefX509CertificateCToCpp::GetValidExpiry() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefBinaryValue> CefX509CertificateCToCpp::GetDEREncoded() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") CefRefPtr<CefBinaryValue> CefX509CertificateCToCpp::GetPEMEncoded() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") void CefX509CertificateCToCpp::GetDEREncodedIssuerChain(IssuerChainBinaryList& chain) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall") void CefX509CertificateCToCpp::GetPEMEncodedIssuerChain(IssuerChainBinaryList& chain) {
  shutdown_checker::AssertNotShutdown();
...
template<> cef_x509_certificate_t* CefCToCppRefCounted<CefX509CertificateCToCpp, CefX509Certificate, cef_x509_certificate_t>::UnwrapDerived(CefWrapperType type, CefX509Certificate* c) {
  CHECK(false) << __func__ << " called with unexpected class type " << type;
  return nullptr;
}

template<> CefWrapperType CefCToCppRefCounted<CefX509CertificateCToCpp, CefX509Certificate, cef_x509_certificate_t>::kWrapperType = WT_X509_CERTIFICATE;
