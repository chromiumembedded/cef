...
class CefTranslatorTestScopedLibraryChildCToCpp
    : public CefCToCppScoped<CefTranslatorTestScopedLibraryChildCToCpp, CefTranslatorTestScopedLibraryChild, cef_translator_test_scoped_library_child_t> {
 public:
...
constexpr auto CefTranslatorTestScopedLibraryChildCToCpp_Wrap = CefTranslatorTestScopedLibraryChildCToCpp::Wrap;
constexpr auto CefTranslatorTestScopedLibraryChildCToCpp_UnwrapOwn = CefTranslatorTestScopedLibraryChildCToCpp::UnwrapOwn;
constexpr auto CefTranslatorTestScopedLibraryChildCToCpp_UnwrapRaw = CefTranslatorTestScopedLibraryChildCToCpp::UnwrapRaw;
