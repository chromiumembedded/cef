...
class CefTranslatorTestRefPtrLibraryChildChildCToCpp
    : public CefCToCppRefCounted<CefTranslatorTestRefPtrLibraryChildChildCToCpp, CefTranslatorTestRefPtrLibraryChildChild, cef_translator_test_ref_ptr_library_child_child_t> {
 public:
...
constexpr auto CefTranslatorTestRefPtrLibraryChildChildCToCpp_Wrap = CefTranslatorTestRefPtrLibraryChildChildCToCpp::Wrap;
constexpr auto CefTranslatorTestRefPtrLibraryChildChildCToCpp_Unwrap = CefTranslatorTestRefPtrLibraryChildChildCToCpp::Unwrap;
