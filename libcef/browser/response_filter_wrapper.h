...
#ifndef CEF_LIBCEF_BROWSER_RESPONSE_FILTER_WRAPPER_H_
#define CEF_LIBCEF_BROWSER_RESPONSE_FILTER_WRAPPER_H_
...
#endif  // CEF_LIBCEF_BROWSER_RESPONSE_FILTER_WRAPPER_H_
