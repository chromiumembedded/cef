...
IMPLEMENT_ADDREF(simple_browser_view_delegate_t,
                 browser_view_delegate,
                 ref_count)
IMPLEMENT_HAS_ONE_REF(simple_browser_view_delegate_t,
                      browser_view_delegate,
                      ref_count)
IMPLEMENT_HAS_AT_LEAST_ONE_REF(simple_browser_view_delegate_t,
                               browser_view_delegate,
                               ref_count)

// Release function for browser view delegate.
int CEF_CALLBACK browser_view_delegate_release(cef_base_ref_counted_t* self) {
...
simple_browser_view_delegate_t* browser_view_delegate_create(
  ...
  delegate->delegate.base.base.add_ref = browser_view_delegate_add_ref;
  delegate->delegate.base.base.release = browser_view_delegate_release;
  delegate->delegate.base.base.has_one_ref = browser_view_delegate_has_one_ref;
  delegate->delegate.base.base.has_at_least_one_ref =
      browser_view_delegate_has_at_least_one_ref;
...
IMPLEMENT_ADDREF(simple_window_delegate_t, window_delegate, ref_count)
IMPLEMENT_HAS_ONE_REF(simple_window_delegate_t, window_delegate, ref_count)
IMPLEMENT_HAS_AT_LEAST_ONE_REF(simple_window_delegate_t,
                               window_delegate,
                               ref_count)
...
simple_window_delegate_t* window_delegate_create(
  ...
  delegate->delegate.base.base.base.add_ref = window_delegate_add_ref;
  delegate->delegate.base.base.base.release = window_delegate_release;
  delegate->delegate.base.base.base.has_one_ref = window_delegate_has_one_ref;
  delegate->delegate.base.base.base.has_at_least_one_ref =
      window_delegate_has_at_least_one_ref;
