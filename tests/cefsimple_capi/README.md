...
1. **[CEF Tutorial](https://bitbucket.org/chromiumembedded/cef/wiki/Tutorial.md)** - Start here to understand CEF architecture and concepts using the C++ cefsimple example
2. **[Using the C API](https://bitbucket.org/chromiumembedded/cef/wiki/UsingTheCAPI.md)** - Learn C-specific patterns and reference counting rules
...
- [CEF Tutorial](https://bitbucket.org/chromiumembedded/cef/wiki/Tutorial.md) - Architecture overview (uses C++ examples)
- [CEF C API Documentation](https://bitbucket.org/chromiumembedded/cef/wiki/UsingTheCAPI.md) - C-specific patterns
