...
#ifndef CEF_TESTS_SHARED_BROWSER_OSR_ACCESSIBILITY_NODE_H_
#define CEF_TESTS_SHARED_BROWSER_OSR_ACCESSIBILITY_NODE_H_
#pragma once
...
#endif  // CEF_TESTS_SHARED_BROWSER_OSR_ACCESSIBILITY_NODE_H_
