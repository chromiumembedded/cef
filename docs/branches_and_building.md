...
CEF is currently tracking even-numbered Chromium milestone branches (new CEF branch every ~4 weeks, adjusted for holidays). Support for new branches begins when they enter the Chromium beta channel. Support for older branches ends when they exit the Chromium stable channel (after [2 weeks](https://developer.chrome.com/blog/chrome-two-week-release) as stable), unless that branch also qualifies for [extended](https://support.google.com/chrome/a/answer/16942104?hl=en) and/or [LTC/LTS](https://support.google.com/chrome/a/answer/11333726?hl=en) channels.

  * **Stable channel:** Every other Chromium milestone branch starting with M152. These branches receive broad security fixes for ~2 weeks after entering the stable channel.
  * **Extended channel:** Every fourth Chromium milestone branch starting with M152. These branches receive broad security fixes for ~8 weeks total (including time spent in stable).
  * **LTC/LTS channel:** Every 12th Chromium milestone branch starting with M160 (every sixth from M138-M150). These branches receive platform-agnostic security fixes for ~9 months total (including time spent in stable and/or extended).
...
|:--------|:--------------|:--------|:------------|:--------------|:---------------------------|:----------------------------|:-------------------------|
| Stable   | [8037](https://github.com/chromiumembedded/cef/tree/8037) | 154              | Sep 2026    | Oct 5, 2026  | Win 10+ deployment, Win 10+ build system w/ VS2022 17.13.4, Win 10.0.28000.2270 SDK, Ninja | macOS 12.0+ deployment, 15.6+ build system w/ 26.0 base SDK (Xcode 26.0), Ninja, 64-bit only | Ubuntu 20.04+, Debian 10+, Ninja |
| Extended | [7977](https://github.com/chromiumembedded/cef/tree/7977) | 152              | Aug 2026    | Oct 20, 2026 | Win 10+ deployment, Win 10+ build system w/ VS2022 17.13.4, Win 10.0.26100.7705 SDK, Ninja | macOS 12.0+ deployment, 15.6+ build system w/ 26.0 base SDK (Xcode 26.0), Ninja, 64-bit only | Ubuntu 20.04+, Debian 10+, Ninja |
